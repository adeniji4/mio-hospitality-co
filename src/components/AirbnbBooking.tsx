  ...
  return <section className="mobile-featured-property-section bg-red-950">
      <div className="container mx-auto px-4">
              ...
              {properties.map((property, index) => <div key={property.id} className="flex-[0_0_100%] min-w-0 pl-4">
                ...
                once: true
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-8 bg-white rounded-xl shadow-lg overflow-hidden mobile-featured-property-card">
                      <div className="relative mobile-featured-property-image relative h-full w-full overflow-hidden">
                      ...
                      <div className="mobile-featured-property-content flex flex-col justify-between">
                        ...
                        <div className="mobile-featured-property-buttons flex flex-row justify-center items-center gap-2 sm:gap-3 md:gap-4">
                          <Button variant="outline" onClick={() => setSelectedProperty(property)} className="border-[#4a1403] bg-white text-[#4a1403] hover:bg-[#4a1403] hover:text-white w-auto mobile-featured-property-button">
                            View Details
                          </Button>
                          <Button onClick={() => handleBookNow(property.id)} className="text-white bg-[#4a1403] hover:bg-white hover:text-[#4a1403] border border-transparent hover:border-[#4a1403] w-auto mobile-featured-property-button">
                            Book Now
                          </Button>
                        </div>
                      </div>
        ...
        <div className="mt-8 sm:mt-10 md:mt-12 text-center">
          <Button variant="outline" onClick={() => navigate('/properties')} className="border-[#4a1403] bg-white text-[#4a1403] hover:bg-[#4a1403] hover:text-white mobile-featured-property-button">
