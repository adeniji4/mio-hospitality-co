                ...
                <Card className="h-full flex flex-col overflow-hidden hover:shadow-lg transition-shadow duration-300">
                  ...
                  <CardFooter className="pt-1 sm:pt-2 p-2 sm:p-3 md:p-4 flex flex-col gap-1 sm:gap-2">
                    ...
                    <Button 
                      ...
                      className="w-full bg-[#4f1002] hover:bg-white hover:text-[#4a1403] border border-transparent hover:border-[#4a1403] text-white text-xs"
                    >
                      Book Now
                    </Button>
                  </CardFooter>
            ...
            <div className="flex justify-center items-center mt-8 gap-4">
              ...
              {currentPage < totalPages && (
                <Button 
                  ...
                  className="bg-[#4f1002] hover:bg-white hover:text-[#4a1403] border border-transparent hover:border-[#4a1403] text-white"
                >
                  Load More
                </Button>
              )}
