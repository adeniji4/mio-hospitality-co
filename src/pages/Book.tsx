              ...
              <Tabs defaultValue={selectedTab} value={selectedTab} onValueChange={handleTabChange} className="w-full">
                ...
                <TabsContent value="general">
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <Button type="submit" disabled={loading} className="w-full text-white transition-colors bg-wine-500 hover:bg-white hover:text-[#4a1403] border border-transparent hover:border-[#4a1403]">
                ...
                <TabsContent value="car" className="px-1 md:px-4">
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <Button type="submit" disabled={loading} className="w-full transition-colors bg-wine-500 hover:bg-white hover:text-[#4a1403] border border-transparent hover:border-[#4a1403] text-amber-50">
