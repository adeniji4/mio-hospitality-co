  ...
  return (
    <ServiceLayout>
      <div className="min-h-screen bg-white">
        ...
        description="Experience the thrill of driving our luxury and exotic car fleet, available for hire across Nigeria. From sports cars to SUVs, we have the perfect vehicle for every occasion."
        description2=""
