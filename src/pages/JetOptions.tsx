  ...
  return (
    <ServiceLayout>
      <div className="min-h-screen bg-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
              {jets.map((jet, index) => (
                <motion.div 
                  ...
                  viewport={{ once: true }}
                >
                  <Card className="overflow-hidden hover:shadow-xl transition-al</div>l duration-300 group h-full flex flex-col">
        ...
        <ServiceCta
        title="Want a Private Jet Experience?"
        description="Experience the luxury and convenience of private jet travel with our exclusive fleet. Whether for business or leisure, we have the perfect aircraft to suit your needs."
        description2=""
        primaryButtonText="Get started"
        secondaryButtonText="learn more"
        primaryButtonLink="/book?service=jet-hire"
        secondaryButtonLink="/contact"
        backgroundImage="https://plus.unsplash.com/premium_photo-1679830513873-5f9163fcc04a?q=80&w=3027&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
      />
