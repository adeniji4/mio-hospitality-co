...
//Airbnb hero section
  return (
    <ServiceLayout>
      <ServiceHero
        title=" Airbnb hosting and management"
        ...
        description={
          <>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-4 mt-6">
              <Button 
                asChild
                className="bg-[#4a1403] hover:bg-white hover:text-[#4a1403] border-2 border-[#4a1403] text-white rounded-full w-[280px] md:w-auto"
              >
              ...
              <Button 
                ...
                className="border-2 border-[#4a1403] bg-white text-[#4a1403] hover:bg-[#4a1403] hover:text-white rounded-full w-[280px] md:w-auto"
              >
                Book This Service
              </Button>
            </div>
      ...
      <section className="py-16 bg-gray-50">
         <h2 className="text-3xl font-bold mb-6 text-zinc-800 flex justify-center mt-4 -mt-10 mb-8">Expertly Managed & Seamless Stays</h2>
          <br />
              ...
              <Card className="border-none shadow-lg bg-white h-full">
                <CardContent className="pt-6 px-6 pb-8">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    We provide complete hands-off and End-to-End management for your Airbnb properties, from start to finish. 
                  </p>
                  <p className="font-bold text-gray-900 leading-relaxed">
                    Our services include:
                    <ul className="font-light list-disc ml-5 text-gray-600">
                      <li>Listing Creation & Optimization: Crafting high-converting listings with professional photos and engaging descriptions.</li>
                      <li>Guest Communication: Handling all inquiries, bookings, and feedback with promptness and care.</li>
                      <li>Cleaning & Maintenance Coordination: Ensuring your property stays in perfect condition with regular cleaning and quick resolution of maintenance needs.</li>
                      <li>Revenue Management: Optimizing pricing and booking rates to maximize income potential.</li>
                      <li>24/7 Support: Our team is always available to manage any guest or property issues, ensuring smooth operations.</li>
                    </ul>
                  </p>
                </CardContent>
              </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              <Card className="border-none shadow-lg bg-gray-50 h-full">
                <CardContent className="pt-6 px-6 pb-8">
                  <h2 className="text-3xl font-bold mb-6 text-zinc-800">Airbnb Hosting</h2>
                  <p className="text-gray-600 leading-relaxed">
                    We offer our guests exceptional stays where every detail is thoughtfully curated. Whether you're traveling for business or leisure, we ensure your experience is comfortable, convenient, and truly memorable. 
                  </p>
                  <p className="font-bold text-gray-900 leading-relaxed">
                    Here’s what awaits you:
                    <ul className="font-light list-disc ml-5 text-gray-600">
                      <li>Handpicked Properties: Carefully selected for design, comfort, and premium amenities.</li>
                      <li>Personalized Guest Experiences: Tailored to meet your individual needs, from local recommendations to custom services.</li>
                      <li>24/7 Guest Support: Ready to assist at any time for seamless communication and quick resolution of any issues.</li>
                      <li>Exclusive Offers: Enjoy special deals and packages that enhance your stay.</li>
                    </ul>
                  </p>
                </CardContent>
              </Card>
