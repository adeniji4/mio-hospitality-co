...
const CarHire = () => {
  ...
  const galleryImages = [
    ...
    {
      id: 'gallery-10',
      src: 'https://images.unsplash.com/photo-1742445131888-bf3c42a6d215?q=80&w=2942&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    ...
    {
      id: 'gallery-12',
      src: 'https://images.unsplash.com/photo-1533558701576-23c65e0272fb?q=80&w=3087&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
  ...
  return (
    <ServiceLayout>
      ...
      <ServiceIntroduction
        ...
        secondaryButtonText="Reserve a Car"
      ...
      <ServiceCta
        ...
        description2=''
        primaryButtonText="Reserve a car"
